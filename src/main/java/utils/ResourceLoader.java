...
public class ResourceLoader {
    ...
    private BufferedImage resizeSpriteSmooth(BufferedImage sprite, double ratio) {
        ...
        int currentColour;
        BufferedImage outlineSprite = new BufferedImage(sprite.getWidth(), sprite.getHeight(), BufferedImage.TYPE_4BYTE_ABGR);
        BufferedImage spriteWithoutOutline = new BufferedImage(sprite.getWidth(), sprite.getHeight(), BufferedImage.TYPE_4BYTE_ABGR);
        ;
