...
public class MipsManRouteFinder implements RouteFinder {
   ...
   * avoids other {@link Entity Entities} whilst also travelling towards the nearest {@link
   * com.lordsofmidnight.objects.PowerUpBox PowerUpBox}.
   *
