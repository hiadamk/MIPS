...
public class ServerGameplayHandler {
    ...
    public ServerGameplayHandler(ArrayList<InetAddress> ips, int numPlayers) throws IOException {
        ...
        this.ipStore = ips;
        this.sender = new PacketSender(NetworkUtility.CLIENT_DGRAM_PORT, this.outgoingQueue,
            ipStore);
    ...
    private void initialisePacketManagers() {
        ...
        // Don't think this is needed anymore as the packet sender is directly watching the outgoing
        // queue which the telemetry adds to.
