...
public class LabelGenerator {
  ...
  public static Label generate(
      boolean visible, Pane root, String text, UIColours colour, int fontSize) {
   ...
   * @return The created label
   */
  public static Label generate(boolean visible, String text, UIColours colour, int fontSize) {
    Label newLabel = new Label(text);
    newLabel.setVisible(visible);
    newLabel.setStyle(" -fx-font-size:" + fontSize + "pt ; -fx-text-fill: " + colour + ";");
    return newLabel;
