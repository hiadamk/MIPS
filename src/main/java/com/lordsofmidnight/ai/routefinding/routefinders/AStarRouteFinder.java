...
public class AStarRouteFinder implements RouteFinder {
  ...
  /**
   * Initialises the A* for the specified {@link Map} and corresponding junction set and edge mapping.
   *
  ...
  public Direction getRoute(Point myLocation, Point targetLocation) {
    ...
    if (junctions.contains(targetLocation)) {
      ...
      targetJunction =
          Mapping.findNearestJunction(targetLocation, map, junctions).getGridCoord();
    }
