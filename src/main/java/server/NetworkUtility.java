...
public class NetworkUtility {
  ...
  public static String makeEntitiyMovementPacket(Input input, Point position) {
    return "POS1" + input.toString() + "|" + coordFormat.format(position.getX()) + "|" + coordFormat.format(position.getY());
  }
  ...
  public static String makeItemPositionPacket(int itemID, Point2D.Double position) {
    return "POS2" + itemID + "|" + coordFormat.format(position.getX()) + "|" + coordFormat.format(position.getY());
  }
  ...
  public static String makeEntitiesPositionPacket(Entity[] agents) {
    ...
    for (int i = 0; i < agents.length; i++) {
      s += i + ":" + coordFormat.format(agents[i].getLocation().getX()) +
