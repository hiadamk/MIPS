...
import server.ClientGameplayHandler;
...
public class Client extends Application {
  ...
  private LinkedList<Input> incomingQueue; //only used in singleplayer
...
//        audioController.playMusic(Sounds.intro);
  ...
  private void startGame() {
    ...
    if (id ==0){telemetry.startAI();} //shouldnt start AI if we're running DumbTelemetry
  }
